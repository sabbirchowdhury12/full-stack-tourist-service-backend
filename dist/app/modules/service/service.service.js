...
const getAllService = (filters, options) =>
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const reviewUserIds =
      result === null || result === void 0
        ? void 0
        : result.reviews.map((review) => review.userId);
    const ratingUserIds =
      result === null || result === void 0
        ? void 0
        : result.ratings.map((rating) => rating.userId);
    ...
    const reviewsWithUserNames =
      result === null || result === void 0
        ...
        : result.reviews.map((review) =>
            Object.assign(Object.assign({}, review), {
              user: reviewUsers.find((user) => user.id === review.userId),
            })
          );
    const ratingsWithUserNames =
      result === null || result === void 0
        ? void 0
        : result.ratings.map((rating) =>
            Object.assign(Object.assign({}, rating), {
...
const getAvailableService = (searchValue) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (searchValue) {
